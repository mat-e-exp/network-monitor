...
for years in timeframes:
    ...
    if start_year in year_end_prices:
        ...
        # Actual = start price multiplied by CAGR for the number of years
        actual_price = start_price * pow(1 + (cagr/100), years)
        
        # Difference between actual and end
...
print(f"\nNote: Current FTSE assumed to be {current_ftse}")
print("CAGR calculated backwards from current level to historical start point")
print("Actual = Start price × (1 + CAGR)^Years")
print("Difference = Actual - End")